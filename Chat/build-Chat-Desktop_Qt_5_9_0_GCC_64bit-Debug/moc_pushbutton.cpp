...
#include "../Chat/BasicControls/pushbutton.h"
...
QT_MOC_LITERAL(1, 11, 18), // "setBackgroundColor"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 5) // "color"

    },
    "PushButton\0setBackgroundColor\0\0color"
};
...
void PushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setBackgroundColor((*reinterpret_cast< QColor(*)>(_a[1]))); break;
        default: ;
        }
    }
}
